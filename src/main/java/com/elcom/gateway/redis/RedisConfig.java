...
//    }
    ...
    @Bean
    @Primary
    public RedisTemplate<String, IpInformation> redisTemplate() {
        RedisTemplate<String, IpInformation> template = new RedisTemplate<>();
...
//    }
        ...
        private void configureSerializers(RedisTemplate<String, IpInformation> redisTemplate) {
